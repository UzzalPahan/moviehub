const Footer = () => {
  return (
    <div>
      <footer className="footer p-10 bg-[#032541] text-white">
        <aside>
          <svg
            width="50"
            height="50"
        ...
        <nav>
          <header className="footer-title">THE BASICS</header>
        ...
        <nav>
          <header className="footer-title font-bold">GET INVOLVED</header>
